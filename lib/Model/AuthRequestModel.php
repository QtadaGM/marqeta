...
/**
 * AuthRequestModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuthRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auth_request_model';
    ...
    protected static $openAPITypes = [
        ...
        'card_options' => '\OpenAPI\Client\Model\CardOptions',
        'card_token' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['card_options'] = $data['card_options'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pin']) && (mb_strlen($this->container['pin']) > 50)) {
            $invalidProperties[] = "invalid value for 'pin', the character length must be smaller than or equal to 50.";
        }
     ...
     * Gets card_options
     *
     * @return \OpenAPI\Client\Model\CardOptions|null
     */
     ...
     * Sets card_options
     *
     * @param \OpenAPI\Client\Model\CardOptions|null $card_options card_options
     *
     * @return self
     */
    ...
    public function setCardToken($card_token)
    {
        if ((mb_strlen($card_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling AuthRequestModel., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($card_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling AuthRequestModel., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($mid) > 50)) {
            throw new \InvalidArgumentException('invalid length for $mid when calling AuthRequestModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($mid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mid when calling AuthRequestModel., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($pin) && (mb_strlen($pin) > 50)) {
            throw new \InvalidArgumentException('invalid length for $pin when calling AuthRequestModel., must be smaller than or equal to 50.');
        }
        if (!is_null($pin) && (mb_strlen($pin) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pin when calling AuthRequestModel., must be bigger than or equal to 1.');
        }
