...
/**
 * BankTransferRequestModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BankTransferRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bank_transfer_request_model';
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling BankTransferRequestModel., must be bigger than or equal to 0.01.');
        }
    ...
    public function setCreatedBy($created_by)
    {
        if (!is_null($created_by) && (mb_strlen($created_by) > 255)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling BankTransferRequestModel., must be smaller than or equal to 255.');
        }
        if (!is_null($created_by) && (mb_strlen($created_by) < 0)) {
            throw new \InvalidArgumentException('invalid length for $created_by when calling BankTransferRequestModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code Currency of the push or pull.
     *
     * @return self
     */
    ...
    public function setFundingSourceToken($funding_source_token)
    {
        if ((mb_strlen($funding_source_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_token when calling BankTransferRequestModel., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($funding_source_token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_token when calling BankTransferRequestModel., must be bigger than or equal to 0.');
        }
    ...
    public function setStatementDescriptor($statement_descriptor)
    {
        if (!is_null($statement_descriptor) && (mb_strlen($statement_descriptor) > 10)) {
            throw new \InvalidArgumentException('invalid length for $statement_descriptor when calling BankTransferRequestModel., must be smaller than or equal to 10.');
        }
        if (!is_null($statement_descriptor) && (mb_strlen($statement_descriptor) < 0)) {
            throw new \InvalidArgumentException('invalid length for $statement_descriptor when calling BankTransferRequestModel., must be bigger than or equal to 0.');
        }
    ...
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling BankTransferRequestModel., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token when calling BankTransferRequestModel., must be bigger than or equal to 0.');
        }
