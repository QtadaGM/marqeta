...
/**
 * RewardEntriesJournalEntriesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RewardEntriesJournalEntriesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RewardEntriesJournalEntriesResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['related_journal_entry_token']) && (mb_strlen($this->container['related_journal_entry_token']) > 36)) {
     ...
     *
     * @param string|null $related_journal_entry_token Unique identifier of the related journal entry to which the reward rule was applied to trigger the reward entry.
     *
     * @return self
     */
    public function setRelatedJournalEntryToken($related_journal_entry_token)
    {
        if (!is_null($related_journal_entry_token) && (mb_strlen($related_journal_entry_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $related_journal_entry_token when calling RewardEntriesJournalEntriesResponse., must be smaller than or equal to 36.');
        }
     ...
     *
     * @param float|null $transaction_amount The transaction amount to which the reward rule was applied. Used to determine the value of the reward entry.
     *
     * @return self
     */
