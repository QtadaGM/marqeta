...
/**
 * AutoReloadAssociation Class Doc Comment
 *
 * @category Class
 * @description Specifies the scope of the auto reload.  Input no more than one field. If no value is supplied, the auto reload applies at the program level.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AutoReloadAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auto_reload_association';
     ...
     * Sets business_token
     *
     * @param string|null $business_token Unique identifier of the business for which the auto reload is configured.  Send a `GET` request to `/businesses` to retrieve business tokens.
     *
     * @return self
     */
    public function setBusinessToken($business_token)
    {
        if (!is_null($business_token) && (mb_strlen($business_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $business_token when calling AutoReloadAssociation., must be smaller than or equal to 36.');
        }
        if (!is_null($business_token) && (mb_strlen($business_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_token when calling AutoReloadAssociation., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $card_product_token Unique identifier of the card product for which the auto reload is configured.  Send a `GET` request to `/cardproducts` to retrieve card product tokens.
     *
     * @return self
     */
    public function setCardProductToken($card_product_token)
    {
        if (!is_null($card_product_token) && (mb_strlen($card_product_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $card_product_token when calling AutoReloadAssociation., must be smaller than or equal to 36.');
        }
        if (!is_null($card_product_token) && (mb_strlen($card_product_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_product_token when calling AutoReloadAssociation., must be bigger than or equal to 1.');
        }
     ...
     * Sets user_token
     *
     * @param string|null $user_token Unique identifier of the user for which the auto reload is configured.  Send a `GET` request to `/users` to retrieve user tokens.
     *
     * @return self
     */
    public function setUserToken($user_token)
    {
        if (!is_null($user_token) && (mb_strlen($user_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling AutoReloadAssociation., must be smaller than or equal to 36.');
        }
        if (!is_null($user_token) && (mb_strlen($user_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling AutoReloadAssociation., must be bigger than or equal to 1.');
        }
