...
/**
 * SettlementData Class Doc Comment
 *
 * @category Class
 ...
 */
class SettlementData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'settlement_data';
     ...
     * Sets amount
     *
     * @param float|null $amount The settled amount.
     *
     * @return self
     */
     ...
     *
     * @param float|null $conversion_rate Returned when the transaction currency is different from the origination currency.  Conversion rate between the origination currency and the settlement currency.
     *
     * @return self
     */
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code The ISO 4217 code of the currency used in the transaction.
     *
     * @return self
     */
