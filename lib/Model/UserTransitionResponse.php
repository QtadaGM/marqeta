...
/**
 * UserTransitionResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserTransitionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserTransitionResponse';
     ...
     * Sets token
     *
     * @param string $token Unique identifier of the user transition.
     *
     * @return self
     */
     ...
     * Sets user_token
     *
     * @param string|null $user_token Unique identifier of the user whose status was transitioned.
     *
     * @return self
     */
