...
/**
 * StoreResponseModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StoreResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'store_response_model';
    ...
    protected static $setters = [
        ...
        'keyed_auth_cvv_enforced' => 'setKeyedAuthCvvEnforced',
    ...
    protected static $getters = [
        ...
        'keyed_auth_cvv_enforced' => 'getKeyedAuthCvvEnforced',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['keyed_auth_cvv_enforced'] = $data['keyed_auth_cvv_enforced'] ?? false;
        ...
        $this->container['merchant_token'] = $data['merchant_token'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['address1']) > 255)) {
        ...
        if ($this->container['merchant_token'] === null) {
            $invalidProperties[] = "'merchant_token' can't be null";
        }
        if ((mb_strlen($this->container['merchant_token']) > 36)) {
            $invalidProperties[] = "invalid value for 'merchant_token', the character length must be smaller than or equal to 36.";
        }

        if ((mb_strlen($this->container['merchant_token']) < 0)) {
            $invalidProperties[] = "invalid value for 'merchant_token', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['network_mid']) && (mb_strlen($this->container['network_mid']) > 50)) {
            $invalidProperties[] = "invalid value for 'network_mid', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['network_mid']) && (mb_strlen($this->container['network_mid']) < 1)) {
            $invalidProperties[] = "invalid value for 'network_mid', the character length must be bigger than or equal to 1.";
        }
    ...
    {
        if ((mb_strlen($address1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling StoreResponseModel., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($address1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling StoreResponseModel., must be smaller than or equal to 255.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling StoreResponseModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setContact($contact)
    {
        if (!is_null($contact) && (mb_strlen($contact) > 40)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling StoreResponseModel., must be smaller than or equal to 40.');
        }
        if (!is_null($contact) && (mb_strlen($contact) < 0)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setContactEmail($contact_email)
    {
        if (!is_null($contact_email) && (mb_strlen($contact_email) > 40)) {
            throw new \InvalidArgumentException('invalid length for $contact_email when calling StoreResponseModel., must be smaller than or equal to 40.');
        }
        if (!is_null($contact_email) && (mb_strlen($contact_email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $contact_email when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 40)) {
            throw new \InvalidArgumentException('invalid length for $country when calling StoreResponseModel., must be smaller than or equal to 40.');
        }
        if (!is_null($country) && (mb_strlen($country) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets keyed_auth_cvv_enforced
     *
     * @return bool|null
     */
    public function getKeyedAuthCvvEnforced()
    {
        return $this->container['keyed_auth_cvv_enforced'];
    }

    /**
     * Sets keyed_auth_cvv_enforced
     *
     * @param bool|null $keyed_auth_cvv_enforced keyed_auth_cvv_enforced
     *
     * @return self
     */
    public function setKeyedAuthCvvEnforced($keyed_auth_cvv_enforced)
    {
        $this->container['keyed_auth_cvv_enforced'] = $keyed_auth_cvv_enforced;
     ...
     * Sets merchant_token
     *
     * @param string $merchant_token merchant_token
     *
     * @return self
     */
    public function setMerchantToken($merchant_token)
    {
        if ((mb_strlen($merchant_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $merchant_token when calling StoreResponseModel., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($merchant_token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_token when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    {
        if ((mb_strlen($mid) > 50)) {
            throw new \InvalidArgumentException('invalid length for $mid when calling StoreResponseModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($mid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mid when calling StoreResponseModel., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StoreResponseModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets network_mid
     *
     * @param string|null $network_mid network_mid
     *
     * @return self
     */
    public function setNetworkMid($network_mid)
    {
        if (!is_null($network_mid) && (mb_strlen($network_mid) > 50)) {
            throw new \InvalidArgumentException('invalid length for $network_mid when calling StoreResponseModel., must be smaller than or equal to 50.');
        }
        if (!is_null($network_mid) && (mb_strlen($network_mid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $network_mid when calling StoreResponseModel., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool|null $partial_auth_flag 1 char max
     *
     * @return self
     */
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling StoreResponseModel., must be smaller than or equal to 10.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling StoreResponseModel., must be smaller than or equal to 10.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setProvince($province)
    {
        if (!is_null($province) && (mb_strlen($province) > 20)) {
            throw new \InvalidArgumentException('invalid length for $province when calling StoreResponseModel., must be smaller than or equal to 20.');
        }
        if (!is_null($province) && (mb_strlen($province) < 0)) {
            throw new \InvalidArgumentException('invalid length for $province when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setState($state)
    {
        if ((mb_strlen($state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $state when calling StoreResponseModel., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling StoreResponseModel., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling StoreResponseModel., must be bigger than or equal to 1.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling StoreResponseModel., must be smaller than or equal to 10.');
        }
        if (!is_null($zip) && (mb_strlen($zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling StoreResponseModel., must be bigger than or equal to 0.');
        }
