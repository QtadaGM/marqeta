...
class JournalEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['card_token']) && (mb_strlen($this->container['card_token']) < 8)) {
     ...
     * Sets account_token
     *
     * @param string $account_token Unique identifier of the credit account associated with the credit card used to make the journal entry.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount Amount of the journal entry.
     *
     * @return self
     */
     ...
     * Sets card_token
     *
     * @param string|null $card_token Unique identifier of the credit card used to make the journal entry.
     *
     * @return self
     */
    public function setCardToken($card_token)
    {
        if (!is_null($card_token) && (mb_strlen($card_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling JournalEntry., must be smaller than or equal to 36.');
        }
        if (!is_null($card_token) && (mb_strlen($card_token) < 8)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling JournalEntry., must be bigger than or equal to 8.');
        }
     ...
     * Sets created_time
     *
     * @param \DateTime $created_time Date and time when the journal entry was created on Marqeta's credit platform, in UTC.
     *
     * @return self
     */
     ...
     * Sets detail_object
     *
     * @param object|null $detail_object detail_object
     *
     * @return self
     */
     ...
     * Sets detail_token
     *
     * @param string $detail_token Unique identifier of the journal entry's full details.
     *
     * @return self
     */
     ...
     * Sets dispute_token
     *
     * @param string|null $dispute_token Unique identifier of the dispute, if the journal entry is disputed.
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string $group Group to which the journal entry belongs.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Eight-digit numeric identifier of the journal entry, an alternate identifier to the UUID that is useful for remembering and referencing.
     *
     * @return self
     */
    ...
    {
        if ((mb_strlen($id) > 8)) {
            throw new \InvalidArgumentException('invalid length for $id when calling JournalEntry., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($id) < 8)) {
            throw new \InvalidArgumentException('invalid length for $id when calling JournalEntry., must be bigger than or equal to 8.');
        }
     ...
     * Sets impact_time
     *
     * @param \DateTime $impact_time Date and time when the journal entry impacts the account balance.  For purchases, this is the time of the authorization.  For purchase authorization clearings, this is the time when the transaction is settled.
     *
     * @return self
     */
     ...
     * Sets memo
     *
     * @param string|null $memo Merchant name or description for the journal entry.
     *
     * @return self
     */
     ...
     * Sets related_token
     *
     * @param string|null $related_token Unique identifier of the original journal entry. If the current journal entry is the original, this field is returned empty.
     *
     * @return self
     */
     ...
     * Sets request_time
     *
     * @param \DateTime $request_time For purchases, the date and time of the authorization, which is when the user initiates the journal entry.  For other journal entry groups, equivalent to `impact_time`.
     *
     * @return self
     */
     ...
     * Sets root_token
     *
     * @param string|null $root_token Unique identifier of the root journal entry. If the current journal entry is the root, this field is returned empty.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string $token Unique identifier of the journal entry.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Journal entry event type.
     *
     * @return self
     */
     ...
     * Sets user_token
     *
     * @param string $user_token Unique identifier of the credit user.
     *
     * @return self
     */
