...
/**
 * BusinessIncorporation Class Doc Comment
 *
 * @category Class
 ...
 */
class BusinessIncorporation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'business_incorporation';
    ...
    protected static $openAPITypes = [
        'address_registered_under' => '\OpenAPI\Client\Model\AddressRequestModel',
    ...
    const INCORPORATION_TYPE_COOPERATIVE = 'COOPERATIVE';
    ...
    public function getIncorporationTypeAllowableValues()
    {
        return [
            ...
            self::INCORPORATION_TYPE_COOPERATIVE,
     ...
     *
     * @param \OpenAPI\Client\Model\AddressRequestModel|null $address_registered_under address_registered_under
     *
     * @return self
     */
     ...
     *
     * @param string|null $incorporation_type Organizational structure of the business, such as corporation or sole proprietorship.  This field is required for KYC verification (US-based accounts only).
     *
     * @return self
     */
    public function setIncorporationType($incorporation_type)
    {
        ...
        if (!is_null($incorporation_type) && (mb_strlen($incorporation_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $incorporation_type when calling BusinessIncorporation., must be smaller than or equal to 255.');
        }
        if (!is_null($incorporation_type) && (mb_strlen($incorporation_type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $incorporation_type when calling BusinessIncorporation., must be bigger than or equal to 0.');
        }
     ...
     * Sets is_public
     *
     * @param bool|null $is_public A value of `true` indicates that the business is publicly held.
     *
     * @return self
     */
     ...
     *
     * @param string|null $name_registered_under Name under which the business is registered.
     *
     * @return self
     */
    public function setNameRegisteredUnder($name_registered_under)
    {
        if (!is_null($name_registered_under) && (mb_strlen($name_registered_under) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name_registered_under when calling BusinessIncorporation., must be smaller than or equal to 255.');
        }
        if (!is_null($name_registered_under) && (mb_strlen($name_registered_under) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name_registered_under when calling BusinessIncorporation., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $state_of_incorporation State where the business is incorporated.  This field is required for KYC verification (US-based accounts only).
     *
     * @return self
     */
    public function setStateOfIncorporation($state_of_incorporation)
    {
        if (!is_null($state_of_incorporation) && (mb_strlen($state_of_incorporation) > 255)) {
            throw new \InvalidArgumentException('invalid length for $state_of_incorporation when calling BusinessIncorporation., must be smaller than or equal to 255.');
        }
        if (!is_null($state_of_incorporation) && (mb_strlen($state_of_incorporation) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state_of_incorporation when calling BusinessIncorporation., must be bigger than or equal to 0.');
        }
     ...
     * Sets stock_symbol
     *
     * @param string|null $stock_symbol Business stock symbol.
     *
     * @return self
     */
    public function setStockSymbol($stock_symbol)
    {
        if (!is_null($stock_symbol) && (mb_strlen($stock_symbol) > 255)) {
            throw new \InvalidArgumentException('invalid length for $stock_symbol when calling BusinessIncorporation., must be smaller than or equal to 255.');
        }
        if (!is_null($stock_symbol) && (mb_strlen($stock_symbol) < 0)) {
            throw new \InvalidArgumentException('invalid length for $stock_symbol when calling BusinessIncorporation., must be bigger than or equal to 0.');
        }
