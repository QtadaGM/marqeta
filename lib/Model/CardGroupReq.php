...
/**
 * CardGroupReq Class Doc Comment
 *
 * @category Class
 ...
 */
class CardGroupReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardGroupReq';
     ...
     * Sets card_token
     *
     * @param string $card_token Unique identifier token of the card token to be associated with the group.
     *
     * @return self
     */
    public function setCardToken($card_token)
    {
        if ((mb_strlen($card_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling CardGroupReq., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($card_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling CardGroupReq., must be bigger than or equal to 1.');
        }
