...
/**
 * DigitalWalletXPayProvisionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DigitalWalletXPayProvisionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'digital_wallet_x_pay_provision_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['token_requestor_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'token_requestor_id', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setCardToken($card_token)
    {
        if ((mb_strlen($card_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling DigitalWalletXPayProvisionRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($card_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling DigitalWalletXPayProvisionRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets device_id
     *
     * @param string $device_id Unique identifier of the user's XPay device, as provided by XPay during the provisioning process.
     *
     * @return self
     */
    public function setDeviceId($device_id)
    {
        if ((mb_strlen($device_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $device_id when calling DigitalWalletXPayProvisionRequest., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($device_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $device_id when calling DigitalWalletXPayProvisionRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProvisioningAppVersion($provisioning_app_version)
    {
        if ((mb_strlen($provisioning_app_version) > 50)) {
            throw new \InvalidArgumentException('invalid length for $provisioning_app_version when calling DigitalWalletXPayProvisionRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($provisioning_app_version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $provisioning_app_version when calling DigitalWalletXPayProvisionRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTokenRequestorId($token_requestor_id)
    {
        if ((mb_strlen($token_requestor_id) > 11)) {
            throw new \InvalidArgumentException('invalid length for $token_requestor_id when calling DigitalWalletXPayProvisionRequest., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($token_requestor_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token_requestor_id when calling DigitalWalletXPayProvisionRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $wallet_account_id User's XPay account identifier, as provided by XPay during the provisioning process.
     *
     * @return self
     */
    public function setWalletAccountId($wallet_account_id)
    {
        if ((mb_strlen($wallet_account_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $wallet_account_id when calling DigitalWalletXPayProvisionRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($wallet_account_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $wallet_account_id when calling DigitalWalletXPayProvisionRequest., must be bigger than or equal to 1.');
        }
