...
/**
 * AddressResponseModel Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressResponseModel';
     ...
     * Sets address1
     *
     * @param string|null $address1 Street name and number of the address.  This field is returned if it exists in the resource.
     *
     * @return self
     */
    public function setAddress1($address1)
    {
        if (!is_null($address1) && (mb_strlen($address1) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling AddressResponseModel., must be smaller than or equal to 35.');
        }
        if (!is_null($address1) && (mb_strlen($address1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling AddressResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 35)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling AddressResponseModel., must be smaller than or equal to 35.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling AddressResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 35)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressResponseModel., must be smaller than or equal to 35.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 40)) {
            throw new \InvalidArgumentException('invalid length for $country when calling AddressResponseModel., must be smaller than or equal to 40.');
        }
        if (!is_null($country) && (mb_strlen($country) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country when calling AddressResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling AddressResponseModel., must be smaller than or equal to 20.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling AddressResponseModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets state
     *
     * @param string|null $state State, province, or territory of the address.  This field is returned if it exists in the resource.
     *
     * @return self
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 35)) {
            throw new \InvalidArgumentException('invalid length for $state when calling AddressResponseModel., must be smaller than or equal to 35.');
        }
        if (!is_null($state) && (mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling AddressResponseModel., must be bigger than or equal to 0.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 20)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling AddressResponseModel., must be smaller than or equal to 20.');
        }
        if (!is_null($zip) && (mb_strlen($zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling AddressResponseModel., must be bigger than or equal to 0.');
        }
