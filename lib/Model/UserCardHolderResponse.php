...
/**
 * UserCardHolderResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UserCardHolderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_card_holder_response';
     ...
     *
     * @param string|null $account_holder_group_token Associates the specified account holder group with the cardholder.
     *
     * @return self
     */
    public function setAccountHolderGroupToken($account_holder_group_token)
    {
        if (!is_null($account_holder_group_token) && (mb_strlen($account_holder_group_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_group_token when calling UserCardHolderResponse., must be smaller than or equal to 36.');
        }
        if (!is_null($account_holder_group_token) && (mb_strlen($account_holder_group_token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_group_token when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets active
     *
     * @param bool|null $active Specifies if the cardholder is in the `ACTIVE` state on the Marqeta platform.
     *
     * @return self
     */
     ...
     * Sets address1
     *
     * @param string|null $address1 Cardholder's address.
     *
     * @return self
     */
    public function setAddress1($address1)
    {
        if (!is_null($address1) && (mb_strlen($address1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($address1) && (mb_strlen($address1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets address2
     *
     * @param string|null $address2 Additional address information for the cardholder.
     *
     * @return self
     */
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets birth_date
     *
     * @param string|null $birth_date Cardholder's date of birth.
     *
     * @return self
     */
     ...
     * Sets business_token
     *
     * @param string|null $business_token Unique identifier of the business resource.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city City where the cardholder resides.
     *
     * @return self
     */
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling UserCardHolderResponse., must be smaller than or equal to 40.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCompany($company)
    {
        if (!is_null($company) && (mb_strlen($company) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($company) && (mb_strlen($company) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets country
     *
     * @param string|null $country Country where the cardholder resides.
     *
     * @return self
     */
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 40)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UserCardHolderResponse., must be smaller than or equal to 40.');
        }
        if (!is_null($country) && (mb_strlen($country) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets email
     *
     * @param string|null $email Valid email address of the cardholder.
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserCardHolderResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserCardHolderResponse., must be smaller than or equal to 40.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setGender($gender)
    {
        ...
        if (!is_null($gender) && (mb_strlen($gender) > 1)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling UserCardHolderResponse., must be smaller than or equal to 1.');
        }
        if (!is_null($gender) && (mb_strlen($gender) < 0)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setHonorific($honorific)
    {
        if (!is_null($honorific) && (mb_strlen($honorific) > 10)) {
            throw new \InvalidArgumentException('invalid length for $honorific when calling UserCardHolderResponse., must be smaller than or equal to 10.');
        }
        if (!is_null($honorific) && (mb_strlen($honorific) < 0)) {
            throw new \InvalidArgumentException('invalid length for $honorific when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $id_card_expiration_date Expiration date of the cardholder's identification.
     *
     * @return self
     */
    ...
    public function setIdCardNumber($id_card_number)
    {
        if (!is_null($id_card_number) && (mb_strlen($id_card_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $id_card_number when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($id_card_number) && (mb_strlen($id_card_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $id_card_number when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\IdentificationResponseModel[]|null $identifications One or more objects containing identifications associated with the cardholder.
     *
     * @return self
     */
    ...
    public function setIpAddress($ip_address)
    {
        if (!is_null($ip_address) && (mb_strlen($ip_address) > 39)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling UserCardHolderResponse., must be smaller than or equal to 39.');
        }
        if (!is_null($ip_address) && (mb_strlen($ip_address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserCardHolderResponse., must be smaller than or equal to 40.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setMiddleName($middle_name)
    {
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling UserCardHolderResponse., must be smaller than or equal to 40.');
        }
        if (!is_null($middle_name) && (mb_strlen($middle_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setNationality($nationality)
    {
        if (!is_null($nationality) && (mb_strlen($nationality) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nationality when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($nationality) && (mb_strlen($nationality) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nationality when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($notes) && (mb_strlen($notes) < 0)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets parent_token
     *
     * @param string|null $parent_token Unique identifier of the parent user or business resource.
     *
     * @return self
     */
    public function setParentToken($parent_token)
    {
        if (!is_null($parent_token) && (mb_strlen($parent_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $parent_token when calling UserCardHolderResponse., must be smaller than or equal to 36.');
        }
        if (!is_null($parent_token) && (mb_strlen($parent_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parent_token when calling UserCardHolderResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPassportNumber($passport_number)
    {
        if (!is_null($passport_number) && (mb_strlen($passport_number) > 40)) {
            throw new \InvalidArgumentException('invalid length for $passport_number when calling UserCardHolderResponse., must be smaller than or equal to 40.');
        }
        if (!is_null($passport_number) && (mb_strlen($passport_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $passport_number when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets password
     *
     * @param string|null $password Password to the cardholder's user account on the Marqeta platform.
     *
     * @return self
     */
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 255)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($password) && (mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserCardHolderResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone Cardholder's telephone number.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserCardHolderResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Postal code of the cardholder's address.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling UserCardHolderResponse., must be smaller than or equal to 10.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets state
     *
     * @param string|null $state State or province where the cardholder resides.
     *
     * @return self
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling UserCardHolderResponse., must be smaller than or equal to 2.');
        }
        if (!is_null($state) && (mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Specifies the status of the cardholder on the Marqeta platform.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the cardholder.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling UserCardHolderResponse., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling UserCardHolderResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool|null $uses_parent_account Indicates whether the child shares balances with the parent (`true`), or the child's balances are independent of the parent (`false`).
     *
     * @return self
     */
     ...
     * Sets zip
     *
     * @param string|null $zip United States ZIP code of the cardholder's address.
     *
     * @return self
     */
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling UserCardHolderResponse., must be smaller than or equal to 10.');
        }
        if (!is_null($zip) && (mb_strlen($zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling UserCardHolderResponse., must be bigger than or equal to 0.');
        }
