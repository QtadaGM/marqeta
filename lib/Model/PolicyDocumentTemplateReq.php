...
/**
 * PolicyDocumentTemplateReq Class Doc Comment
 *
 * @category Class
 ...
 */
class PolicyDocumentTemplateReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyDocumentTemplateReq';
     ...
     * Sets template_token
     *
     * @param string $template_token Unique identifier of a template, which is a document that serves as an initial disclosure but does not contain finalized values.
     *
     * @return self
     */
    public function setTemplateToken($template_token)
    {
        ...
        if ((!preg_match("/(?!^ +$)^.+$/", $template_token))) {
            throw new \InvalidArgumentException("invalid value for $template_token when calling PolicyDocumentTemplateReq., must conform to the pattern /(?!^ +$)^.+$/.");
        }
