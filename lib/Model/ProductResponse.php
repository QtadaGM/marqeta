...
class ProductResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'parent_product_token' => 'setParentProductToken',
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'parent_product_token' => 'getParentProductToken',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['parent_product_token'] = $data['parent_product_token'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['card_product_tokens']) && (count($this->container['card_product_tokens']) < 1)) {
            $invalidProperties[] = "invalid value for 'card_product_tokens', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['min_payment_flat_amount']) && ($this->container['min_payment_flat_amount'] < 0.01)) {
            $invalidProperties[] = "invalid value for 'min_payment_flat_amount', must be bigger than or equal to 0.01.";
        }

        if (!is_null($this->container['min_payment_percentage']) && ($this->container['min_payment_percentage'] > 100)) {
            $invalidProperties[] = "invalid value for 'min_payment_percentage', must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['min_payment_percentage']) && ($this->container['min_payment_percentage'] < 0.00010)) {
            $invalidProperties[] = "invalid value for 'min_payment_percentage', must be bigger than or equal to 0.00010.";
        }

        if (!is_null($this->container['payment_allocation_order']) && (count($this->container['payment_allocation_order']) < 1)) {
            $invalidProperties[] = "invalid value for 'payment_allocation_order', number of items must be greater than or equal to 1.";
        }

        if (!is_null($this->container['usage']) && (count($this->container['usage']) < 1)) {
     ...
     *
     * @param string[]|null $card_product_tokens One or more associated card product tokens.
     *
     * @return self
     */
    public function setCardProductTokens($card_product_tokens)
    {
        ...
        if (!is_null($card_product_tokens) && (count($card_product_tokens) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_product_tokens when calling ProductResponse., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets classification
     *
     * @param \OpenAPI\Client\Model\ProductClassification|null $classification classification
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param \OpenAPI\Client\Model\ProductConfig|null $config config
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime|null $created_time Date and time when the credit product was created on Marqeta's credit platform, in UTC.
     *
     * @return self
     */
     ...
     * Gets credit_line
     *
     * @return \OpenAPI\Client\Model\ProductCreditLine|null
     */
     ...
     * Sets credit_line
     *
     * @param \OpenAPI\Client\Model\ProductCreditLine|null $credit_line credit_line
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\InterestCalculation|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InterestCalculation|null $interest_calculation interest_calculation
     *
     * @return self
     */
     ...
     *
     * @param float|null $min_payment_flat_amount Minimum payment, expressed as a flat amount, due on the payment due day.
     *
     * @return self
     */
    public function setMinPaymentFlatAmount($min_payment_flat_amount)
    {
        ...
        if (!is_null($min_payment_flat_amount) && ($min_payment_flat_amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $min_payment_flat_amount when calling ProductResponse., must be bigger than or equal to 0.01.');
        }
     ...
     *
     * @param float|null $min_payment_percentage Minimum payment, expressed as a percentage of the total statement balance, due on the payment due day.
     *
     * @return self
     */
    public function setMinPaymentPercentage($min_payment_percentage)
    {
        ...
        if (!is_null($min_payment_percentage) && ($min_payment_percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $min_payment_percentage when calling ProductResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($min_payment_percentage) && ($min_payment_percentage < 0.00010)) {
            throw new \InvalidArgumentException('invalid value for $min_payment_percentage when calling ProductResponse., must be bigger than or equal to 0.00010.');
        }
     ...
     * Sets name
     *
     * @param string|null $name Name of the credit product.
     *
     * @return self
     */
    ...
    /**
     * Gets parent_product_token
     *
     * @return string|null
     */
    public function getParentProductToken()
    {
        return $this->container['parent_product_token'];
    }

    /**
     * Sets parent_product_token
     *
     * @param string|null $parent_product_token Unique identifier of the parent credit product.
     *
     * @return self
     */
    public function setParentProductToken($parent_product_token)
    {
        $this->container['parent_product_token'] = $parent_product_token;
     ...
     *
     * @return \OpenAPI\Client\Model\PaymentAllocationOrderEnum[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PaymentAllocationOrderEnum[]|null $payment_allocation_order Ordered list of balance types to which payments are allocated, from first to last.
     *
     * @return self
     */
    public function setPaymentAllocationOrder($payment_allocation_order)
    {
        ...
        if (!is_null($payment_allocation_order) && (count($payment_allocation_order) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_allocation_order when calling ProductResponse., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ProductSubType|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ProductSubType|null $product_sub_type product_sub_type
     *
     * @return self
     */
     ...
     * Sets product_type
     *
     * @param \OpenAPI\Client\Model\ProductType|null $product_type product_type
     *
     * @return self
     */
     ...
     * Sets updated_time
     *
     * @param \DateTime|null $updated_time Date and time when the credit product was last updated on Marqeta's credit platform, in UTC.
     *
     * @return self
     */
     ...
     * Gets usage
     *
     * @return \OpenAPI\Client\Model\BalanceType[]|null
     */
     ...
     * Sets usage
     *
     * @param \OpenAPI\Client\Model\BalanceType[]|null $usage One or more usage types for the credit product.
     *
     * @return self
     */
    public function setUsage($usage)
    {
        ...
        if (!is_null($usage) && (count($usage) < 1)) {
            throw new \InvalidArgumentException('invalid length for $usage when calling ProductResponse., number of items must be greater than or equal to 1.');
        }
