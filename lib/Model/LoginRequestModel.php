...
/**
 * LoginRequestModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoginRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'login_request_model';
     ...
     * Sets email
     *
     * @param string|null $email Cardholder email address.
     *
     * @return self
     */
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 255)) {
            throw new \InvalidArgumentException('invalid length for $password when calling LoginRequestModel., must be smaller than or equal to 255.');
        }
        if (!is_null($password) && (mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling LoginRequestModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets user_token
     *
     * @param string|null $user_token Identifies the cardholder to log in.  Send a `GET` request to `/users` to retrieve user tokens.
     *
     * @return self
     */
    public function setUserToken($user_token)
    {
        if (!is_null($user_token) && (mb_strlen($user_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling LoginRequestModel., must be smaller than or equal to 36.');
        }
        if (!is_null($user_token) && (mb_strlen($user_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling LoginRequestModel., must be bigger than or equal to 1.');
        }
