 ...
 */
class GpaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'gpa_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['funding_source_token']) < 1)) {
    ...
    public function setBusinessToken($business_token)
    {
        if (!is_null($business_token) && (mb_strlen($business_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $business_token when calling GpaRequest., must be smaller than or equal to 36.');
        }
        if (!is_null($business_token) && (mb_strlen($business_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_token when calling GpaRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets fees
     *
     * @param \OpenAPI\Client\Model\FeeModel[]|null $fees List of fees associated with the funding transaction.
     *
     * @return self
     */
     ...
     *
     * @param string|null $funding_source_address_token Unique identifier of the funding source address to use for this order. If your funding source is an ACH account, then a funding source address is not required. If your funding source is a payment card, you must have at least one funding source address in order to create a GPA order. Send a `GET` request to `/fundingsources/addresses/user/{token}` to retrieve addresses for a specific user.
     *
     * @return self
     */
    public function setFundingSourceAddressToken($funding_source_address_token)
    {
        if (!is_null($funding_source_address_token) && (mb_strlen($funding_source_address_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_address_token when calling GpaRequest., must be smaller than or equal to 36.');
        }
        if (!is_null($funding_source_address_token) && (mb_strlen($funding_source_address_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_address_token when calling GpaRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFundingSourceToken($funding_source_token)
    {
        if ((mb_strlen($funding_source_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_token when calling GpaRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($funding_source_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_token when calling GpaRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMemo($memo)
    {
        if (!is_null($memo) && (mb_strlen($memo) > 99)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling GpaRequest., must be smaller than or equal to 99.');
        }
        if (!is_null($memo) && (mb_strlen($memo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling GpaRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTags($tags)
    {
        if (!is_null($tags) && (mb_strlen($tags) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling GpaRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($tags) && (mb_strlen($tags) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling GpaRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the GPA order.  If you do not include a token, the system will generate one automatically. This token is necessary for use in other calls, so we recommend that rather than let the system generate one, you use a simple string that is easy to remember. This value cannot be updated.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling GpaRequest., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling GpaRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUserToken($user_token)
    {
        if (!is_null($user_token) && (mb_strlen($user_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling GpaRequest., must be smaller than or equal to 36.');
        }
        if (!is_null($user_token) && (mb_strlen($user_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling GpaRequest., must be bigger than or equal to 1.');
        }
