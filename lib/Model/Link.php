...
class Link implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets href
     *
     * @param string $href URL of the requested `/balances` resource.
     *
     * @return self
     */
     ...
     * Sets rel
     *
     * @param string $rel Specifies the relationship between the current resource and the linked resource.
     *
     * @return self
     */
