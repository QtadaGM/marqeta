...
class Shipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'care_of_line' => 'string',
        'method' => 'string',
        'recipient_address' => '\OpenAPI\Client\Model\FulfillmentAddressRequest',
        'return_address' => '\OpenAPI\Client\Model\FulfillmentAddressRequest'
    ];
     ...
     * Sets care_of_line
     *
     * @param string|null $care_of_line Adds the specified value as a care of (C/O) line to the mailing carrier.  *NOTE:* This field can be specified on cards, card products, and bulk card orders. If you specify this field at multiple levels, the order of precedence is: card, bulk card order, card product.
     *
     * @return self
     */
     ...
     * Sets method
     *
     * @param string|null $method Specifies the shipping service.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\FulfillmentAddressRequest|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\FulfillmentAddressRequest|null $recipient_address recipient_address
     *
     * @return self
     */
     ...
     * Sets return_address
     *
     * @param \OpenAPI\Client\Model\FulfillmentAddressRequest|null $return_address return_address
     *
     * @return self
     */
