...
/**
 * VelocityControlBalanceResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VelocityControlBalanceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'velocity_control_balance_response';
    ...
    protected static $openAPITypes = [
        ...
        'available' => '\OpenAPI\Client\Model\Available',
    ...
    public function setAmountLimit($amount_limit)
    {
        ...
        if (($amount_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount_limit when calling VelocityControlBalanceResponse., must be bigger than or equal to 0.');
        }
     ...
     * Gets available
     *
     * @return \OpenAPI\Client\Model\Available
     */
     ...
     * Sets available
     *
     * @param \OpenAPI\Client\Model\Available $available available
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VelocityControlBalanceResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VelocityControlBalanceResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling VelocityControlBalanceResponse., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling VelocityControlBalanceResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setUsageLimit($usage_limit)
    {
        ...
        if (!is_null($usage_limit) && ($usage_limit < -1)) {
            throw new \InvalidArgumentException('invalid value for $usage_limit when calling VelocityControlBalanceResponse., must be bigger than or equal to -1.');
        }
