...
/**
 * BusinessCardHolderUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCardHolderUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'business_card_holder_update';
     ...
     *
     * @param string|null $account_holder_group_token Associates the specified account holder group with the business.
     *
     * @return self
     */
    public function setAccountHolderGroupToken($account_holder_group_token)
    {
        if (!is_null($account_holder_group_token) && (mb_strlen($account_holder_group_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_group_token when calling BusinessCardHolderUpdate., must be smaller than or equal to 36.');
        }
        if (!is_null($account_holder_group_token) && (mb_strlen($account_holder_group_token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_group_token when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setAttesterName($attester_name)
    {
        if (!is_null($attester_name) && (mb_strlen($attester_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $attester_name when calling BusinessCardHolderUpdate., must be smaller than or equal to 64.');
        }
        if (!is_null($attester_name) && (mb_strlen($attester_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $attester_name when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setAttesterTitle($attester_title)
    {
        if (!is_null($attester_title) && (mb_strlen($attester_title) > 64)) {
            throw new \InvalidArgumentException('invalid length for $attester_title when calling BusinessCardHolderUpdate., must be smaller than or equal to 64.');
        }
        if (!is_null($attester_title) && (mb_strlen($attester_title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $attester_title when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setBusinessNameDba($business_name_dba)
    {
        if (!is_null($business_name_dba) && (mb_strlen($business_name_dba) > 255)) {
            throw new \InvalidArgumentException('invalid length for $business_name_dba when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($business_name_dba) && (mb_strlen($business_name_dba) < 0)) {
            throw new \InvalidArgumentException('invalid length for $business_name_dba when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setBusinessNameLegal($business_name_legal)
    {
        if (!is_null($business_name_legal) && (mb_strlen($business_name_legal) > 255)) {
            throw new \InvalidArgumentException('invalid length for $business_name_legal when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($business_name_legal) && (mb_strlen($business_name_legal) < 0)) {
            throw new \InvalidArgumentException('invalid length for $business_name_legal when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
     ...
     * Sets business_type
     *
     * @param string|null $business_type Indicates the type of business, for example business-to-business (B2B) or business-to-consumer (B2C).
     *
     * @return self
     */
    public function setBusinessType($business_type)
    {
        if (!is_null($business_type) && (mb_strlen($business_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $business_type when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($business_type) && (mb_strlen($business_type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $business_type when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setDunsNumber($duns_number)
    {
        if (!is_null($duns_number) && (mb_strlen($duns_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $duns_number when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($duns_number) && (mb_strlen($duns_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $duns_number when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setGeneralBusinessDescription($general_business_description)
    {
        if (!is_null($general_business_description) && (mb_strlen($general_business_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $general_business_description when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($general_business_description) && (mb_strlen($general_business_description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $general_business_description when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setHistory($history)
    {
        if (!is_null($history) && (mb_strlen($history) > 255)) {
            throw new \InvalidArgumentException('invalid length for $history when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($history) && (mb_strlen($history) < 0)) {
            throw new \InvalidArgumentException('invalid length for $history when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $international_office_locations Locations of the business' offices outside the United States.
     *
     * @return self
     */
    public function setInternationalOfficeLocations($international_office_locations)
    {
        if (!is_null($international_office_locations) && (mb_strlen($international_office_locations) > 255)) {
            throw new \InvalidArgumentException('invalid length for $international_office_locations when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($international_office_locations) && (mb_strlen($international_office_locations) < 0)) {
            throw new \InvalidArgumentException('invalid length for $international_office_locations when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setIpAddress($ip_address)
    {
        if (!is_null($ip_address) && (mb_strlen($ip_address) > 39)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling BusinessCardHolderUpdate., must be smaller than or equal to 39.');
        }
        if (!is_null($ip_address) && (mb_strlen($ip_address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($notes) && (mb_strlen($notes) < 0)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 255)) {
            throw new \InvalidArgumentException('invalid length for $password when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($password) && (mb_strlen($password) < 0)) {
            throw new \InvalidArgumentException('invalid length for $password when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxpayerId($taxpayer_id)
    {
        if (!is_null($taxpayer_id) && (mb_strlen($taxpayer_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $taxpayer_id when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($taxpayer_id) && (mb_strlen($taxpayer_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $taxpayer_id when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the business.  Send a `GET` request to `/businesses` to retrieve business tokens.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling BusinessCardHolderUpdate., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling BusinessCardHolderUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setWebsite($website)
    {
        if (!is_null($website) && (mb_strlen($website) > 255)) {
            throw new \InvalidArgumentException('invalid length for $website when calling BusinessCardHolderUpdate., must be smaller than or equal to 255.');
        }
        if (!is_null($website) && (mb_strlen($website) < 0)) {
            throw new \InvalidArgumentException('invalid length for $website when calling BusinessCardHolderUpdate., must be bigger than or equal to 0.');
        }
