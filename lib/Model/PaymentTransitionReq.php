...
/**
 * PaymentTransitionReq Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentTransitionReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentTransitionReq';
    ...
    protected static $openAPITypes = [
        'refund_details' => '\OpenAPI\Client\Model\RefundDetails',
     ...
     * Sets refund_details
     *
     * @param \OpenAPI\Client\Model\RefundDetails|null $refund_details refund_details
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the payment status transition.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling PaymentTransitionReq., must be smaller than or equal to 36.');
        }
