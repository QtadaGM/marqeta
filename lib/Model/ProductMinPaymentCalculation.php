...
/**
 * ProductMinPaymentCalculation Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductMinPaymentCalculation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductMinPaymentCalculation';
    ...
    protected static $openAPITypes = [
        ...
        'min_payment_percentage' => '\OpenAPI\Client\Model\ProductMinPaymentPercentage'
    ];
    ...
    public function setMinPaymentFlatAmount($min_payment_flat_amount)
    {
        ...
        if (($min_payment_flat_amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $min_payment_flat_amount when calling ProductMinPaymentCalculation., must be bigger than or equal to 0.01.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ProductMinPaymentPercentage
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ProductMinPaymentPercentage $min_payment_percentage min_payment_percentage
     *
     * @return self
     */
