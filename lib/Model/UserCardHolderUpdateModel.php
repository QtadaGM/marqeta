...
/**
 * UserCardHolderUpdateModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserCardHolderUpdateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserCardHolderUpdateModel';
    ...
    public function setAccountHolderGroupToken($account_holder_group_token)
    {
        if (!is_null($account_holder_group_token) && (mb_strlen($account_holder_group_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_group_token when calling UserCardHolderUpdateModel., must be smaller than or equal to 36.');
        }
        if (!is_null($account_holder_group_token) && (mb_strlen($account_holder_group_token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_group_token when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets address1
     *
     * @param string|null $address1 Cardholder address.  *NOTE:* Required for KYC verification (US-based cardholders only). Cannot perform KYC if set to a PO Box.
     *
     * @return self
     */
    public function setAddress1($address1)
    {
        if (!is_null($address1) && (mb_strlen($address1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($address1) && (mb_strlen($address1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets birth_date
     *
     * @param string|null $birth_date Cardholder date of birth.  *NOTE:* Required for KYC verification (US-based cardholders only).
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city that corresponds to the address.  *NOTE:* Required for KYC verification (US-based cardholders only).
     *
     * @return self
     */
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling UserCardHolderUpdateModel., must be smaller than or equal to 40.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCompany($company)
    {
        if (!is_null($company) && (mb_strlen($company) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($company) && (mb_strlen($company) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets country
     *
     * @param string|null $country Country in which the cardholder resides.  *NOTE:* Required for KYC verification (US-based cardholders only).
     *
     * @return self
     */
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 40)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UserCardHolderUpdateModel., must be smaller than or equal to 40.');
        }
        if (!is_null($country) && (mb_strlen($country) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets email
     *
     * @param string|null $email Valid email address for the cardholder.  This value must be unique among cardholders.
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserCardHolderUpdateModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets first_name
     *
     * @param string|null $first_name Cardholder first name.  *NOTE:* Required for KYC verification (US-based cardholders only).
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserCardHolderUpdateModel., must be smaller than or equal to 40.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
    ...
    public function setGender($gender)
    {
        ...
        if (!is_null($gender) && (mb_strlen($gender) > 1)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling UserCardHolderUpdateModel., must be smaller than or equal to 1.');
        }
        if (!is_null($gender) && (mb_strlen($gender) < 0)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets honorific
     *
     * @param string|null $honorific Cardholder title or prefix: Ms., Mr., Miss, Mrs.
     *
     * @return self
     */
    public function setHonorific($honorific)
    {
        if (!is_null($honorific) && (mb_strlen($honorific) > 10)) {
            throw new \InvalidArgumentException('invalid length for $honorific when calling UserCardHolderUpdateModel., must be smaller than or equal to 10.');
        }
        if (!is_null($honorific) && (mb_strlen($honorific) < 0)) {
            throw new \InvalidArgumentException('invalid length for $honorific when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
    ...
    public function setIdCardNumber($id_card_number)
    {
        if (!is_null($id_card_number) && (mb_strlen($id_card_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $id_card_number when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($id_card_number) && (mb_strlen($id_card_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $id_card_number when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address Cardholder IP address.
     *
     * @return self
     */
    public function setIpAddress($ip_address)
    {
        if (!is_null($ip_address) && (mb_strlen($ip_address) > 39)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling UserCardHolderUpdateModel., must be smaller than or equal to 39.');
        }
        if (!is_null($ip_address) && (mb_strlen($ip_address) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ip_address when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name Cardholder last name.  *NOTE:* Required for KYC verification (US-based cardholders only).
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserCardHolderUpdateModel., must be smaller than or equal to 40.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets middle_name
     *
     * @param string|null $middle_name Cardholder middle name.
     *
     * @return self
     */
    public function setMiddleName($middle_name)
    {
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling UserCardHolderUpdateModel., must be smaller than or equal to 40.');
        }
        if (!is_null($middle_name) && (mb_strlen($middle_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets nationality
     *
     * @param string|null $nationality Cardholder nationality.
     *
     * @return self
     */
    public function setNationality($nationality)
    {
        if (!is_null($nationality) && (mb_strlen($nationality) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nationality when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($nationality) && (mb_strlen($nationality) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nationality when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($notes) && (mb_strlen($notes) < 0)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets parent_token
     *
     * @param string|null $parent_token Unique identifier of an existing user or business resource.  Required if `uses_parent_account = true`. This account holder is configured as the parent of the current cardholder.  To unlink a child account from a parent account, update this field to a null value.
     *
     * @return self
     */
    public function setParentToken($parent_token)
    {
        if (!is_null($parent_token) && (mb_strlen($parent_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $parent_token when calling UserCardHolderUpdateModel., must be smaller than or equal to 36.');
        }
        if (!is_null($parent_token) && (mb_strlen($parent_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parent_token when calling UserCardHolderUpdateModel., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $passport_number Cardholder passport number.
     *
     * @return self
     */
    public function setPassportNumber($passport_number)
    {
        if (!is_null($passport_number) && (mb_strlen($passport_number) > 40)) {
            throw new \InvalidArgumentException('invalid length for $passport_number when calling UserCardHolderUpdateModel., must be smaller than or equal to 40.');
        }
        if (!is_null($passport_number) && (mb_strlen($passport_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $passport_number when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets password
     *
     * @param string|null $password Cardholder's user account password on the Marqeta platform.
     *
     * @return self
     */
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 255)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($password) && (mb_strlen($password) < 0)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone Cardholder telephone number (including area code), prepended by the `+` symbol and the 1- to 3-digit country calling code. Do not include hyphens, spaces, or parentheses.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserCardHolderUpdateModel., must be smaller than or equal to 255.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling UserCardHolderUpdateModel., must be smaller than or equal to 10.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets state
     *
     * @param string|null $state State where the cardholder resides.  *NOTE:* <</core-api/kyc-verification#_valid_state_provincial_and_territorial_abbreviations, Valid two-character abbreviation>> required for KYC verification (US-based cardholders only).
     *
     * @return self
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 32)) {
            throw new \InvalidArgumentException('invalid length for $state when calling UserCardHolderUpdateModel., must be smaller than or equal to 32.');
        }
        if (!is_null($state) && (mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling UserCardHolderUpdateModel., must be bigger than or equal to 0.');
        }
    ...
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling UserCardHolderUpdateModel., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling UserCardHolderUpdateModel., must be bigger than or equal to 1.');
        }
