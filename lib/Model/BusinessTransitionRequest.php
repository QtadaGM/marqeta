...
/**
 * BusinessTransitionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BusinessTransitionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessTransitionRequest';
     ...
     * Sets business_token
     *
     * @param string $business_token Unique identifier of the business whose status you want to transition.
     *
     * @return self
     */
     ...
     *
     * @param string|null $idempotent_hash Unique hashed value that identifies subsequent submissions of the business transition request.
     *
     * @return self
     */
    ...
    public function setReason($reason)
    {
        if (!is_null($reason) && (mb_strlen($reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling BusinessTransitionRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($reason) && (mb_strlen($reason) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling BusinessTransitionRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets status
     *
     * @param string $status Specifies the new status of the business.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the business transition.  If you do not include a token, the system generates one automatically. This token is referenced in other API calls, so we recommend that you define a simple string that is easy to remember. This value cannot be updated.
     *
     * @return self
     */
