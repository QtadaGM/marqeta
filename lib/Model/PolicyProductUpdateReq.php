...
/**
 * PolicyProductUpdateReq Class Doc Comment
 *
 * @category Class
 ...
 */
class PolicyProductUpdateReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyProductUpdateReq';
    ...
    public function setCardProducts($card_products)
    {
        ...
        if ((count($card_products) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_products when calling PolicyProductUpdateReq., number of items must be greater than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PolicyProductUpdateReq., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/(?!^ +$)^.+$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling PolicyProductUpdateReq., must conform to the pattern /(?!^ +$)^.+$/.");
        }
    ...
    public function setUsage($usage)
    {
        ...
        if ((count($usage) < 1)) {
            throw new \InvalidArgumentException('invalid length for $usage when calling PolicyProductUpdateReq., number of items must be greater than or equal to 1.');
        }
