...
/**
 * ReturnedDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ReturnedDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnedDetails';
     ...
     * Sets return_code
     *
     * @param string $return_code Return code for the returned payment. For more, see <</developer-guides/ach-origination#_nacha_ach_return_codes, NACHA ACH return codes>>.
     *
     * @return self
     */
     ...
     * Sets return_reason
     *
     * @param string $return_reason Reason the payment was returned. For more, see <</developer-guides/ach-origination#_nacha_ach_return_codes, NACHA ACH return codes>>.
     *
     * @return self
     */
