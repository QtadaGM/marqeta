...
/**
 * PolicyDocumentResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PolicyDocumentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyDocumentResponse';
    ...
    protected static $openAPITypes = [
        'account_statement' => '\OpenAPI\Client\Model\PolicyDocumentTemplateResponse',
        'benefits_disclosure_premium' => '\OpenAPI\Client\Model\PolicyDocumentAssetResponse',
        'benefits_disclosure_traditional' => '\OpenAPI\Client\Model\PolicyDocumentAssetResponse',
        'card_member_agreement' => '\OpenAPI\Client\Model\PolicyDocumentAssetResponse',
        'created_time' => '\DateTime',
        'e_disclosure' => '\OpenAPI\Client\Model\PolicyDocumentAssetResponse',
        'name' => 'string',
        'noaa_multiple_reason_with_dodd_frank' => '\OpenAPI\Client\Model\PolicyDocumentTemplateResponse',
        'noaa_single_reason' => '\OpenAPI\Client\Model\PolicyDocumentTemplateResponse',
        'noaa_single_reason_with_dodd_frank' => '\OpenAPI\Client\Model\PolicyDocumentTemplateResponse',
        'pre_qualification_disclosure' => '\OpenAPI\Client\Model\PolicyDocumentAssetAndTemplateResponse',
        'privacy_policy' => '\OpenAPI\Client\Model\PolicyDocumentAssetResponse',
        'rewards_disclosure' => '\OpenAPI\Client\Model\PolicyDocumentAssetAndTemplateResponse',
        'summary_of_credit_terms' => '\OpenAPI\Client\Model\PolicyDocumentAssetAndTemplateResponse',
        'terms_schedule' => '\OpenAPI\Client\Model\PolicyDocumentTemplateResponse',
        'token' => 'string',
     ...
     *
     * @return \OpenAPI\Client\Model\PolicyDocumentTemplateResponse|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentTemplateResponse|null $account_statement account_statement
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\PolicyDocumentAssetResponse|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetResponse|null $benefits_disclosure_premium benefits_disclosure_premium
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetResponse|null $benefits_disclosure_traditional benefits_disclosure_traditional
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetResponse|null $card_member_agreement card_member_agreement
     *
     * @return self
     */
     ...
     * Sets created_time
     *
     * @param \DateTime|null $created_time Date and time when the document policy was created on Marqeta's credit platform, in UTC.
     *
     * @return self
     */
     ...
     * Sets e_disclosure
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetResponse|null $e_disclosure e_disclosure
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the document policy.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/(?!^ +$)^.+$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling PolicyDocumentResponse., must conform to the pattern /(?!^ +$)^.+$/.");
        }
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentTemplateResponse|null $noaa_multiple_reason_with_dodd_frank noaa_multiple_reason_with_dodd_frank
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentTemplateResponse|null $noaa_single_reason noaa_single_reason
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentTemplateResponse|null $noaa_single_reason_with_dodd_frank noaa_single_reason_with_dodd_frank
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\PolicyDocumentAssetAndTemplateResponse|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetAndTemplateResponse|null $pre_qualification_disclosure pre_qualification_disclosure
     *
     * @return self
     */
     ...
     * Sets privacy_policy
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetResponse|null $privacy_policy privacy_policy
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetAndTemplateResponse|null $rewards_disclosure rewards_disclosure
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentAssetAndTemplateResponse|null $summary_of_credit_terms summary_of_credit_terms
     *
     * @return self
     */
     ...
     * Sets terms_schedule
     *
     * @param \OpenAPI\Client\Model\PolicyDocumentTemplateResponse|null $terms_schedule terms_schedule
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the document policy.
     *
     * @return self
     */
    public function setToken($token)
    {
        ...
        if (!is_null($token) && (!preg_match("/(?!^ +$)^.+$/", $token))) {
            throw new \InvalidArgumentException("invalid value for $token when calling PolicyDocumentResponse., must conform to the pattern /(?!^ +$)^.+$/.");
        }
     ...
     * Sets updated_time
     *
     * @param \DateTime|null $updated_time Date and time when the document policy was last updated on Marqeta's credit platform, in UTC.
     *
     * @return self
     */
