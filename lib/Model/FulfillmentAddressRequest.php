...
/**
 * FulfillmentAddressRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FulfillmentAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'fulfillment_address_request';
     ...
     * Sets address1
     *
     * @param string|null $address1 Number and street of the address.
     *
     * @return self
     */
    public function setAddress1($address1)
    {
        if (!is_null($address1) && (mb_strlen($address1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling FulfillmentAddressRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($address1) && (mb_strlen($address1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (mb_strlen($address2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling FulfillmentAddressRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($address2) && (mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling FulfillmentAddressRequest., must be smaller than or equal to 40.');
        }
        if (!is_null($city) && (mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 40)) {
            throw new \InvalidArgumentException('invalid length for $country when calling FulfillmentAddressRequest., must be smaller than or equal to 40.');
        }
        if (!is_null($country) && (mb_strlen($country) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets first_name
     *
     * @param string|null $first_name First name of the addressee.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling FulfillmentAddressRequest., must be smaller than or equal to 40.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name Last name of the addressee.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling FulfillmentAddressRequest., must be smaller than or equal to 40.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets middle_name
     *
     * @param string|null $middle_name Middle name of the addressee.
     *
     * @return self
     */
    public function setMiddleName($middle_name)
    {
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling FulfillmentAddressRequest., must be smaller than or equal to 40.');
        }
        if (!is_null($middle_name) && (mb_strlen($middle_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone Telephone number of the addressee.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling FulfillmentAddressRequest., must be smaller than or equal to 20.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling FulfillmentAddressRequest., must be smaller than or equal to 10.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets state
     *
     * @param string|null $state State of the address.
     *
     * @return self
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 32)) {
            throw new \InvalidArgumentException('invalid length for $state when calling FulfillmentAddressRequest., must be smaller than or equal to 32.');
        }
        if (!is_null($state) && (mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling FulfillmentAddressRequest., must be smaller than or equal to 10.');
        }
        if (!is_null($zip) && (mb_strlen($zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling FulfillmentAddressRequest., must be bigger than or equal to 0.');
        }
