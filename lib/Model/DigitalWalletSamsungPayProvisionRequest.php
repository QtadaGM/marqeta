...
/**
 * DigitalWalletSamsungPayProvisionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DigitalWalletSamsungPayProvisionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'digital_wallet_samsung_pay_provision_request';
    ...
    protected static $setters = [
        ...
        'wallet_user_id' => 'setWalletUserId'
    ];
    ...
    protected static $getters = [
        ...
        'wallet_user_id' => 'getWalletUserId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['wallet_user_id'] = $data['wallet_user_id'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wallet_user_id'] === null) {
            $invalidProperties[] = "'wallet_user_id' can't be null";
        }
        if ((mb_strlen($this->container['wallet_user_id']) > 50)) {
            $invalidProperties[] = "invalid value for 'wallet_user_id', the character length must be smaller than or equal to 50.";
        }

        if ((mb_strlen($this->container['wallet_user_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'wallet_user_id', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setCardToken($card_token)
    {
        if ((mb_strlen($card_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling DigitalWalletSamsungPayProvisionRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($card_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling DigitalWalletSamsungPayProvisionRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets device_id
     *
     * @param string $device_id User's Samsung device unique identifier, as provided by Samsung during the provisioning process.
     *
     * @return self
     */
    public function setDeviceId($device_id)
    {
        if ((mb_strlen($device_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $device_id when calling DigitalWalletSamsungPayProvisionRequest., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($device_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $device_id when calling DigitalWalletSamsungPayProvisionRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProvisioningAppVersion($provisioning_app_version)
    {
        if ((mb_strlen($provisioning_app_version) > 50)) {
            throw new \InvalidArgumentException('invalid length for $provisioning_app_version when calling DigitalWalletSamsungPayProvisionRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($provisioning_app_version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $provisioning_app_version when calling DigitalWalletSamsungPayProvisionRequest., must be bigger than or equal to 1.');
        }
     ...
     * @return string
     */
    public function getWalletUserId()
    {
        return $this->container['wallet_user_id'];
    }

    /**
     * Sets wallet_user_id
     *
     * @param string $wallet_user_id User's Samsung Wallet account ID, as provided by Samsung during the provisioning process.
     *
     * @return self
     */
    public function setWalletUserId($wallet_user_id)
    {
        if ((mb_strlen($wallet_user_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $wallet_user_id when calling DigitalWalletSamsungPayProvisionRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($wallet_user_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $wallet_user_id when calling DigitalWalletSamsungPayProvisionRequest., must be bigger than or equal to 1.');
        }

        $this->container['wallet_user_id'] = $wallet_user_id;
