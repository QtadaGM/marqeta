 ...
 */
class ExpirationOffset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expiration_offset';
     ...
     * Sets unit
     *
     * @param string|null $unit Specifies the units for the `value` field in this object.
     *
     * @return self
     */
