 ...
 */
class MinOffset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'min_offset';
     ...
     * Sets unit
     *
     * @param string|null $unit Specifies the time unit of the `value` field.
     *
     * @return self
     */
