...
/**
 * CardholderBalance Class Doc Comment
 *
 * @category Class
 ...
 */
class CardholderBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cardholder_balance';
     ...
     *
     * @param float $available_balance Ledger balance minus any authorized transactions that have not yet cleared. Also known as the cardholder's purchasing power. When using JIT Funding, this balance is usually equal to $0.00.
     *
     * @return self
     */
     ...
     * Gets balances
     *
     * @return array<string,\OpenAPI\Client\Model\CardholderBalance>
     */
     ...
     * Sets balances
     *
     * @param array<string,\OpenAPI\Client\Model\CardholderBalance> $balances Contains GPA balance information, organized by currency code.
     *
     * @return self
     */
     ...
     * Sets cached_balance
     *
     * @param float $cached_balance Not currently in use.
     *
     * @return self
     */
     ...
     * Sets credit_balance
     *
     * @param float $credit_balance Not currently in use.
     *
     * @return self
     */
     ...
     *
     * @param float|null $impacted_amount Balance change based on the amount of the transaction.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $last_updated_time Date and time when the resource was last updated, in UTC.
     *
     * @return self
     */
     ...
     * Sets ledger_balance
     *
     * @param float $ledger_balance When using standard funding: The funds that are available to spend immediately, including funds from any authorized transactions that have not yet cleared. When using Just-in-Time (JIT) Funding: Authorized funds that are currently on hold, but not yet cleared.
     *
     * @return self
     */
     ...
     *
     * @param float $pending_credits ACH loads that have been accepted, but for which the funding time has not yet elapsed.
     *
     * @return self
     */
