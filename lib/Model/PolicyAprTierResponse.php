...
/**
 * PolicyAprTierResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PolicyAprTierResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyAprTierResponse';
     ...
     * Sets apr
     *
     * @param float|null $apr Value of the APR.
     *
     * @return self
     */
     ...
     * Sets margin_rate
     *
     * @param float|null $margin_rate Margin rate for the risk tier for a pricing strategy.
     *
     * @return self
     */
