...
/**
 * ExpirationOffsetWithMinimum Class Doc Comment
 *
 * @category Class
 ...
 */
class ExpirationOffsetWithMinimum implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expiration_offset_with_minimum';
    ...
    protected static $openAPITypes = [
        'min_offset' => '\OpenAPI\Client\Model\MinOffset',
        'unit' => 'string',
        'value' => 'int'
    ];
    ...
    {
        $this->container['min_offset'] = $data['min_offset'] ?? null;
     ...
     * Gets min_offset
     *
     * @return \OpenAPI\Client\Model\MinOffset|null
     */
    public function getMinOffset()
    {
        return $this->container['min_offset'];
    }

    /**
     * Sets min_offset
     *
     * @param \OpenAPI\Client\Model\MinOffset|null $min_offset min_offset
     *
     * @return self
     */
    public function setMinOffset($min_offset)
    {
        $this->container['min_offset'] = $min_offset;
     ...
     * Sets unit
     *
     * @param string|null $unit Specifies the units for the `value` field.
     *
     * @return self
     */
