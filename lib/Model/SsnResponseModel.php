...
/**
 * SsnResponseModel Class Doc Comment
 *
 * @category Class
 ...
 */
class SsnResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ssn_response_model';
     ...
     * Sets nin
     *
     * @param string|null $nin National Identification Number (NIN).
     *
     * @return self
     */
     ...
     * Sets sin
     *
     * @param string|null $sin Social Insurance Number (SIN).
     *
     * @return self
     */
     ...
     * Sets ssn
     *
     * @param string|null $ssn United States Social Security Number (SSN).
     *
     * @return self
     */
     ...
     * Sets tin
     *
     * @param string|null $tin Taxpayer Identification Number (TIN).
     *
     * @return self
     */
