...
/**
 * PaymentScheduleTransitionCreateReq Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentScheduleTransitionCreateReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentScheduleTransitionCreateReq';
    ...
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling PaymentScheduleTransitionCreateReq., must be smaller than or equal to 36.');
        }
