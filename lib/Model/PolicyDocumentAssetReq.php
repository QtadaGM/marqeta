...
/**
 * PolicyDocumentAssetReq Class Doc Comment
 *
 * @category Class
 ...
 */
class PolicyDocumentAssetReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyDocumentAssetReq';
     ...
     * Sets asset_token
     *
     * @param string $asset_token Unique identifier of the asset, which is a type of document that contains finalized values. The values are finalized when the bundle containing the document is created.
     *
     * @return self
     */
    public function setAssetToken($asset_token)
    {
        ...
        if ((!preg_match("/(?!^ +$)^.+$/", $asset_token))) {
            throw new \InvalidArgumentException("invalid value for $asset_token when calling PolicyDocumentAssetReq., must conform to the pattern /(?!^ +$)^.+$/.");
        }
