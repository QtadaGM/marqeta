...
/**
 * BankTransferTransitionRequestModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BankTransferTransitionRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bank_transfer_transition_request_model';
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling BankTransferTransitionRequestModel., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $bank_transfer_token Token of the ACH transfer you want to transition.
     *
     * @return self
     */
    public function setBankTransferToken($bank_transfer_token)
    {
        if ((mb_strlen($bank_transfer_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $bank_transfer_token when calling BankTransferTransitionRequestModel., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($bank_transfer_token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_transfer_token when calling BankTransferTransitionRequestModel., must be bigger than or equal to 0.');
        }
    ...
    public function setProgramReserveToken($program_reserve_token)
    {
        if (!is_null($program_reserve_token) && (mb_strlen($program_reserve_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $program_reserve_token when calling BankTransferTransitionRequestModel., must be smaller than or equal to 36.');
        }
        if (!is_null($program_reserve_token) && (mb_strlen($program_reserve_token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $program_reserve_token when calling BankTransferTransitionRequestModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets reason
     *
     * @param string|null $reason Description of why the ACH transfer status was updated.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status New state of the ACH transfer.  *NOTE:* In production environments, the only value to which you are allowed to transition an ACH transfer is `CANCELLED`.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the bank transfer transition request.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling BankTransferTransitionRequestModel., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token when calling BankTransferTransitionRequestModel., must be bigger than or equal to 0.');
        }
