...
class Account implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets email_address
     *
     * @param string|null $email_address Digital wallet provider's email address for the cardholder.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Digital wallet provider's identity number for the cardholder.
     *
     * @return self
     */
     ...
     * Sets score
     *
     * @param string|null $score Score from the digital wallet provider.
     *
     * @return self
     */
