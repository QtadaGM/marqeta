...
/**
 * BalanceInquiryRequestModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BalanceInquiryRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'balance_inquiry_request_model';
    ...
    public function setCardToken($card_token)
    {
        if ((mb_strlen($card_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling BalanceInquiryRequestModel., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($card_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_token when calling BalanceInquiryRequestModel., must be bigger than or equal to 1.');
        }
    ...
    {
        if ((mb_strlen($mid) > 50)) {
            throw new \InvalidArgumentException('invalid length for $mid when calling BalanceInquiryRequestModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($mid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mid when calling BalanceInquiryRequestModel., must be bigger than or equal to 1.');
        }
    ...
    public function setPin($pin)
    {
        if (!is_null($pin) && (mb_strlen($pin) > 15)) {
            throw new \InvalidArgumentException('invalid length for $pin when calling BalanceInquiryRequestModel., must be smaller than or equal to 15.');
        }
        if (!is_null($pin) && (mb_strlen($pin) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pin when calling BalanceInquiryRequestModel., must be bigger than or equal to 1.');
        }
