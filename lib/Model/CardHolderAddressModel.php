...
/**
 * CardHolderAddressModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CardHolderAddressModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'card_holder_address_model';
     ...
     * Sets address_1
     *
     * @param string $address_1 Street name and number of the address.
     *
     * @return self
     */
    public function setAddress1($address_1)
    {
        if ((mb_strlen($address_1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_1 when calling CardHolderAddressModel., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($address_1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_1 when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
    ...
    public function setAddress2($address_2)
    {
        if (!is_null($address_2) && (mb_strlen($address_2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_2 when calling CardHolderAddressModel., must be smaller than or equal to 255.');
        }
        if (!is_null($address_2) && (mb_strlen($address_2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_2 when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
    ...
    public function setBusinessToken($business_token)
    {
        if (!is_null($business_token) && (mb_strlen($business_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $business_token when calling CardHolderAddressModel., must be smaller than or equal to 36.');
        }
        if (!is_null($business_token) && (mb_strlen($business_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_token when calling CardHolderAddressModel., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CardHolderAddressModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
    ...
    public function setCountry($country)
    {
        if ((mb_strlen($country) > 40)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CardHolderAddressModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CardHolderAddressModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets first_name
     *
     * @param string $first_name First name or given name of the account holder.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        if ((mb_strlen($first_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CardHolderAddressModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($first_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name Last name or family name of the account holder.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        if ((mb_strlen($last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CardHolderAddressModel., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CardHolderAddressModel., must be smaller than or equal to 255.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CardHolderAddressModel., must be smaller than or equal to 10.');
        }
        if (!is_null($postal_code) && (mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets state
     *
     * @param string $state Two-character state, province, or territorial abbreviation.  For a complete list of valid state and province abbreviations, see <</core-api/kyc-verification#_valid_state_provincial_and_territorial_abbreviations, Valid state, provincial, and territorial abbreviations>>.
     *
     * @return self
     */
    public function setState($state)
    {
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling CardHolderAddressModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the address. If you do not include a token, the system will generate one automatically. This token is necessary for use in other API calls, so we recommend that rather than let the system generate one, you use a simple string that is easy to remember. This value cannot be updated.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling CardHolderAddressModel., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling CardHolderAddressModel., must be bigger than or equal to 1.');
        }
    ...
    public function setUserToken($user_token)
    {
        if (!is_null($user_token) && (mb_strlen($user_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling CardHolderAddressModel., must be smaller than or equal to 36.');
        }
        if (!is_null($user_token) && (mb_strlen($user_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_token when calling CardHolderAddressModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets zip
     *
     * @param string|null $zip United States ZIP code. This field is required if `postal_code` is not specified.
     *
     * @return self
     */
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling CardHolderAddressModel., must be smaller than or equal to 10.');
        }
        if (!is_null($zip) && (mb_strlen($zip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling CardHolderAddressModel., must be bigger than or equal to 0.');
        }
