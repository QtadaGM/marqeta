...
/**
 * SamsungPushTokenizeRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class SamsungPushTokenizeRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'samsung_push_tokenize_request_data';
     ...
     *
     * @param string|null $token_service_provider Specifies the network that provides the digital wallet token service, as determined by the Samsung Wallet library.
     *
     * @return self
     */
