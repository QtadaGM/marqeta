...
/**
 * PolicyDocumentCreateReq Class Doc Comment
 *
 * @category Class
 ...
 */
class PolicyDocumentCreateReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PolicyDocumentCreateReq';
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/(?!^ +$)^.+$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling PolicyDocumentCreateReq., must conform to the pattern /(?!^ +$)^.+$/.");
        }
    ...
    public function setToken($token)
    {
        ...
        if (!is_null($token) && (!preg_match("/(?!^ +$)^.+$/", $token))) {
            throw new \InvalidArgumentException("invalid value for $token when calling PolicyDocumentCreateReq., must conform to the pattern /(?!^ +$)^.+$/.");
        }
