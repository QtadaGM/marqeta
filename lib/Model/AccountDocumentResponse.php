...
/**
 * AccountDocumentResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountDocumentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountDocumentResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['effective_from'] = $data['effective_from'] ?? null;
    }
     ...
     * Sets accepted_at
     *
     * @param \DateTime|null $accepted_at Date and time when the user accepted the document on Marqeta's credit platform, in UTC.
     *
     * @return self
     */
     ...
     * Sets asset_token
     *
     * @param string|null $asset_token Unique identifier of the document on a credit account.
     *
     * @return self
     */
     ...
     * Sets effective_from
     *
     * @param \DateTime|null $effective_from Date and time when the document goes into effect on Marqeta's credit platform, in UTC.
     *
     * @return self
     */
