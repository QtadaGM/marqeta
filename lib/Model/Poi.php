...
class Poi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'atm' => 'bool',
        'ecommerce' => 'bool',
        'other' => '\OpenAPI\Client\Model\OtherPoi'
    ];
    ...
    {
        $this->container['atm'] = $data['atm'] ?? false;
        $this->container['ecommerce'] = $data['ecommerce'] ?? true;
     ...
     * Sets atm
     *
     * @param bool|null $atm If set to `true`, cards can be used for withdrawing cash at an ATM and for receiving cash back at a point of sale (POS).
     *
     * @return self
     */
     ...
     * Sets ecommerce
     *
     * @param bool|null $ecommerce If set to `true`, cards can be used for online purchases.
     *
     * @return self
     */
     ...
     * Gets other
     *
     * @return \OpenAPI\Client\Model\OtherPoi|null
     */
     ...
     * Sets other
     *
     * @param \OpenAPI\Client\Model\OtherPoi|null $other other
     *
     * @return self
     */
