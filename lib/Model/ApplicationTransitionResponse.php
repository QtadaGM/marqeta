...
/**
 * ApplicationTransitionResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationTransitionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationTransitionResponse';
    ...
    protected static $openAPITypes = [
        ...
        'original_status' => '\OpenAPI\Client\Model\ApplicationResourceState',
        'status' => '\OpenAPI\Client\Model\ApplicationResourceState',
        'token' => 'string'
    ];
     ...
     *
     * @param string|null $application_token Unique identifier of the application whose state you transitioned.
     *
     * @return self
     */
    public function setApplicationToken($application_token)
    {
        if (!is_null($application_token) && (mb_strlen($application_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $application_token when calling ApplicationTransitionResponse., must be smaller than or equal to 36.');
        }
     ...
     * Sets created_time
     *
     * @param \DateTime|null $created_time Date and time when the application changed states on the Marqeta platform, in UTC.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ApplicationResourceState|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ApplicationResourceState|null $original_status original_status
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\ApplicationResourceState|null $status status
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Unique identifier of the transition of an application's state.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling ApplicationTransitionResponse., must be smaller than or equal to 36.');
        }
