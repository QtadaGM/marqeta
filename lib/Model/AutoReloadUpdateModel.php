...
/**
 * AutoReloadUpdateModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AutoReloadUpdateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'auto_reload_update_model';
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code Three-digit link:https://www.iso.org/iso-4217-currency-codes.html[ISO 4217 currency code, window=\"_blank\"].
     *
     * @return self
     */
    ...
    public function setFundingSourceAddressToken($funding_source_address_token)
    {
        if (!is_null($funding_source_address_token) && (mb_strlen($funding_source_address_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_address_token when calling AutoReloadUpdateModel., must be smaller than or equal to 36.');
        }
        if (!is_null($funding_source_address_token) && (mb_strlen($funding_source_address_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_address_token when calling AutoReloadUpdateModel., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $funding_source_token Unique identifier of the funding source to use for this auto reload.
     *
     * @return self
     */
    public function setFundingSourceToken($funding_source_token)
    {
        if (!is_null($funding_source_token) && (mb_strlen($funding_source_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_token when calling AutoReloadUpdateModel., must be smaller than or equal to 36.');
        }
        if (!is_null($funding_source_token) && (mb_strlen($funding_source_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $funding_source_token when calling AutoReloadUpdateModel., must be bigger than or equal to 1.');
        }
     ...
     * Gets order_scope
     *
     * @return \OpenAPI\Client\Model\OrderScope|null
     */
     ...
     * Sets order_scope
     *
     * @param \OpenAPI\Client\Model\OrderScope|null $order_scope order_scope
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token The token in the path parameter takes precedence over the `token` body field.
     *
     * @return self
     */
    public function setToken($token)
    {
        if (!is_null($token) && (mb_strlen($token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $token when calling AutoReloadUpdateModel., must be smaller than or equal to 36.');
        }
        if (!is_null($token) && (mb_strlen($token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $token when calling AutoReloadUpdateModel., must be bigger than or equal to 1.');
        }
