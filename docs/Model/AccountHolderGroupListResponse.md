...
**data** | [**\OpenAPI\Client\Model\AccountHolderGroupResponse[]**](AccountHolderGroupResponse.md) | Array of account holder group objects.  Objects are returned as appropriate to your query. | [optional]
