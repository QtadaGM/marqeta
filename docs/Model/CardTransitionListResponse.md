...
**data** | [**\OpenAPI\Client\Model\CardTransitionResponse[]**](CardTransitionResponse.md) | Array of card transition objects.  Objects are returned as appropriate to your query. | [optional]
