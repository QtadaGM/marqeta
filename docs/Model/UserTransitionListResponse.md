...
**data** | [**\OpenAPI\Client\Model\UserTransitionResponse[]**](UserTransitionResponse.md) | Array of user transition resources.  Resources are returned as appropriate to your query. | [optional]
