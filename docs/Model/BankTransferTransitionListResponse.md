...
**data** | [**\OpenAPI\Client\Model\BankTransferTransitionResponseModel[]**](BankTransferTransitionResponseModel.md) | Array of ACH transfer transition objects.  This field is returned if there are resources in your returned array. | [optional]
