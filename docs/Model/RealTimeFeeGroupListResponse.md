...
**data** | [**\OpenAPI\Client\Model\RealTimeFeeGroup[]**](RealTimeFeeGroup.md) | Array of real time fee group objects.  Objects are returned as appropriate to your query. | [optional]
